...
from ui import apply_theme, navbar, require_login, page_header, DASHBOARD_PAGE
apply_theme()
require_login()
navbar(active="Your Finances")

show_language_picker()

page_header(t("Your Finances"))
...
with st.expander(t("➕ Add a new goal")):
    ...
    st.caption(t("Loans are in the 🏦 Loans section further up this page."))
